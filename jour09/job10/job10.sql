...
// Requête SQL pour récupérer toutes les informations des salles triées par capacité croissante
...
if ($result->num_rows > 0) {
    ...
    // Affichage des données des salles triées par capacité croissante
